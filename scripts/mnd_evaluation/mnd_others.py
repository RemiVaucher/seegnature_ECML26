...
SEED = 42
RESULT_FILE = "results/mnd/model_comparison.parquet"

# ========== MODELS ==========
DEGREE = 2

MODELS_DICT: dict[str, BaseEstimator] = {
    "mnd_siglr": SigLR(DEGREE, time_aug=True, lead_lag_aug=True, random_state=SEED),
    "mnd_eegnet": EEGNetClassifier(data_freq=128, random_state=SEED),
    "mnd_eeg_conformer": EEGConformerClassifier(data_freq=128, random_state=SEED),
    "mnd_atcnet": ATCNetClassifier(data_freq=128, random_state=SEED),
}
