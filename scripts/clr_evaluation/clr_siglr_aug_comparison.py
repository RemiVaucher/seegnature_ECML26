...
SEED = 42
RESULT_FILE = "results/clr/aug_comparison.parquet"

# ========== MODELS ==========
DEGREE = 2

MODELS_DICT: dict[str, BaseEstimator] = {
    "clr_siglr_no_aug": SigLR(DEGREE, random_state=SEED),
    "clr_siglr_time_aug": SigLR(DEGREE, time_aug=True, random_state=SEED),
    "clr_siglr_lead_lag_aug": SigLR(DEGREE, lead_lag_aug=True, random_state=SEED),
    "clr_siglr_both_aug": SigLR(
